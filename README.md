...
- **Description**: A dynamic web application that combines music and environmental data to enhance user experiences.
- **Technologies**: JavaScript, CSS, HTML, React, Google Maps API, Spotify Web API, Node.js, Firebase Firestore

### [Another Project](https://github.com/d-negatu/another-project)
